...
const navItems = [
  ...
  { to: '/connections', icon: Radio, label: 'Connections', roles: ['admin'] },
];
    ...
    <>
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-sidebar border-b border-sidebar-border z-50 flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sidebar-foreground font-semibold text-lg">VoteAdmin</span>
        </div>
        <Button 
          variant="ghost" 
          size="icon" 
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed lg:static inset-y-0 left-0 z-50 w-64 bg-sidebar border-r border-sidebar-border transition-transform duration-300 ease-in-out",
        ...
        <div className="h-16 flex items-center gap-3 px-6 border-b border-sidebar-border">
          ...
          <span className="text-sidebar-foreground font-bold text-xl">VoteAdmin</span>
        </div>
        ...
        <div className="p-4 border-t border-sidebar-border">
          <Button 
            ...
            className="w-full justify-start gap-3 text-sidebar-foreground hover:bg-destructive hover:text-destructive-foreground transition-colors"
          >
