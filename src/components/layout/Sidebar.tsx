...
import { LayoutDashboard, Users, Vote, LogOut, Menu, X, Crown, UserPlus, ClipboardList, Sparkles, KeyRound } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/pincode-logs', icon: KeyRound, label: 'PinCode Logs', roles: ['admin'] },
